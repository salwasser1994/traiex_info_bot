...
test_questions = [
    ...
    {
        "q": "3. Какую роль играет ИИ в автоматизации торговли?",
        "options": [
    ...
    {
        "q": "4. Какую из этих задач ИИ выполняет эффективно в сфере инвестиций?",
        "options": [
    ...
    {
        "q": "5. Что является ключевым фактором при использовании ИИ в инвестициях?",
        "options": [
    ...
    {
        "q": "6. Можно ли рассматривать ИИ как 'рычаг' в инвестициях?",
        "options": [
