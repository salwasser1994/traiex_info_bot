...
async def cmd_start(message: types.Message):
    file_id = "BAACAgQAAxkBAAMEaOCyUfBD--7KLooaGw3SZRX9hfYAAkweAAJ43AABU4oZjhDZQJ3zNgQ"
...
async def handle_message(message: types.Message):
    ...
    if text == "📊 Общая картина":
        ...
        await message.answer_photo(
            photo="AgACAgQAAxkBAAMIaOCyl4FJg2xhXzXzxDpLzM7n1CAAAn7PMRt43AABU3_h4rzhBNWVAQADAgADeQADNgQ",
        ...
        file_id = "BQACAgQAAxkBAAMGaOCyc049pwkl-m3mLJ0gl2tUGikAAk0eAAJ43AABU_wCBh8ZKuLvNgQ"
