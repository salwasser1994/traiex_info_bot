...
100 USDT — рабочий депозит.",
    "Какова доходность в месяц?": "Ориентировочная доходность — от 6% до 12% в месяц. Показатели могут меняться в зависимости от результатов торговли.",
    "Можно ли сразу снять депозит?": "Да, вывод возможен в любой момент, если отсутствуют форс-мажорные обстоятельства. Перед началом работы рекомендуется ознакомиться с договором оферты.",
    "Как зарегистрироваться?": "https://traiex.gitbook.io/user-guides/ru/kak-zaregistrirovatsya-na-traiex",
    "Где посмотреть лицензию?": "Все документы и лицензии размещены на официальном сайте биржи. https://www.traiex.com/ru/termsandconditions?anchor=1",
    "Есть ли поддержка?": "Да, служба поддержки доступна и готова помочь. https://traiex-help.freshdesk.com/support/home",
    "Есть ли гарантии?": "Гарантированной прибыли нет. Если кто-то обещает стопроцентные гарантии, это должно вызвать вопросы. Все условия подробно описаны в договоре оферты."
}
